...
var Mensagem = function () {
    function Mensagem() {
        ...
        //Atribuindo um valor padrão para o parametro do construtor
        this._texto = texto;
    }
    ...
    _createClass(Mensagem, [{
        key: 'texto',
        get: function get() {
            //Usando o metodo get para visualizar o valor do objeto
            return this._texto;
        },
        set: function set(texto) {
            //Usando o metodo set para alterar os dados
            this._texto = texto;
        }
    }]);
